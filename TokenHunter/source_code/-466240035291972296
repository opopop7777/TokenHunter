...
contract WallBlockChainCoinToken is ERC20, ERC20Detailed {
    using SafeMath for uint256;
    uint256 private constant totalWB= 210000000 * (10 ** 18); // Total amount of WB tokens
    uint256 private constant INITIAL_SUPPLY = 21000000 * (10 ** 18); // Initial circulation quantity
    uint256 private constant FIRST_MONTH_COIN = 8500000 * (10 ** 18); // First Month Coin
    uint private constant MONTHLY_PERCENTAGE = 97; // Monthly Increase Percentage in the Year
    ...
    constructor () public ERC20Detailed("Wall Block Chain Coin", "WB", 18) {
        ...
        quantity = 0;
        startTime = 1564765200; // 2019-08-03 01:00:00
    }
    function runQuantityWB(address _to) public {
        ...
        if(block.timestamp > startTime){
            ...
            for (uint i = 1; i <= 36; i++){ // Circular month
            if(i == 1){
