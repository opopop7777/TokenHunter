...
contract GEC is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function GEC() {
        ...
        name = "Gec";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "GEC";                                             // Set the symbol for display purposes (CHANGE THIS)
