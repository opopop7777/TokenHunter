...
contract StandardToken is ERC223Interface, Owned {
    ...
    constructor(string _symbol, string _name, uint8 _decimals, uint256 totalSupply) public {
    ...
    function transferToAddress(address _to, uint _value, bytes _data) private returns (bool success) {
        ...
        emit Transfer1(msg.sender, _to, _value, _data);
        return true;
    }
