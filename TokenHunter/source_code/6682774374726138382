...
// File: contracts/OrcToken.sol

pragma solidity ^0.4.18;


contract OrcToken is PausableToken {

    string  public  constant name = "Oracle System";
    string  public  constant symbol = "ORC";
    uint8   public  constant decimals = 18;

    mapping(address => uint) approvedInvestorListWithDate;

    function OrcToken( address _admin, uint256 _totalTokenAmount )
    {
        admin = _admin;
