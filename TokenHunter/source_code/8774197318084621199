...
// ----------------------------------------------------------------------------------------------
// ELD token by electrumdarkLimited.
// An ERC20 standard
//
// author: electrumdark community
...
contract electrumdark is StandardToken, OnlyOwner{
	uint256 public constant decimals = 18;
    string public constant name = "electrumdark";
    string public constant symbol = "ELD";
    string public constant version = "1.0";
    uint256 public constant totalSupply =21000000*10**18;
